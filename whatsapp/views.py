...
def api_upload_image_and_syllabus(request):
    ...
    if not question_image_file or not syllabus_file:
        return JsonResponse(
            {'error': 'Both image and syllabus files are required.'},
            status=400)
    ...
    try:
        ...
        return JsonResponse({'error': f'Error processing syllabus: {str(e)}'},
                            status=400)
    ...
    try:
        ...
        return JsonResponse({'error': f'Error extracting question: {str(e)}'},
                            status=400)
    ...
    try:
        ...
        logger.error(f"Error generating answer: {e}")
        return JsonResponse({'error': f'Error generating answer: {str(e)}'},
                            status=400)
    ...
    try:
        ...
        return JsonResponse({'error': f'Error saving question: {str(e)}'},
                            status=500)
